...
function textToBinary() {
  ...
  const binaryResult = textToBinaryString(inputText);
  document.getElementById('output').innerText = `Binary: ${binaryResult}`;
}

function binaryToText() {
  const inputText = document.getElementById('inputText').value;
  const textResult = binaryStringToText(inputText);
  document.getElementById('output').innerText = `Text: ${textResult}`;
}
